...
export function Payouts() {
  ...
  return (
    <div className="flex flex-col gap-block">
      ...
      {/* ── ONE EXPLAINER, BELOW THE MONEY ───────────────────────────────
          This was inside `Card`, which is rendered four times -- so the
          payouts screen opened with the same four-step lifecycle printed
          FOUR TIMES, once under each KPI. It is reference material, so it
          belongs once, after the rows, and closed: "why has this not arrived
          yet" is the question this screen generates, and the answer (it
          releases after the event AND its refund window) is not guessable
          from a status chip. Open once, understood forever. */}
